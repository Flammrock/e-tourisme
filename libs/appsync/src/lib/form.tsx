...
import { SocialIcons, SupportedSocialProvider } from './federatedSignIn';
...
import { SelfAssignedGroups } from '@e-tourisme/data';

import { ListSocialProviders, CustomFieldGroup, redirectSignIn } from './appsync';
